...
public class FloatWindowSmallView extends LinearLayout {
    ...
    public FloatWindowSmallView(Context context, int layoutResId,
        ...
        View touchView = findViewById(R.id.small_window_touchview);
        TextView textView = (TextView) findViewById(R.id.small_window_tip);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.d("FloatWindowSmallView", " onTouchEvent " + event.getAction());
